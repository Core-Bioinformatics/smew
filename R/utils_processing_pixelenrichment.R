...
##'
##' @param x_tf Numeric; x_tf-coordinate of the target pixel.
##' @param y_tf Numeric; y_tf-coordinate of the target pixel.
##' @param intensity.per.sample Matrix or data frame of intensities (pixels x features) for the sample.
##' @param metadata.per.sample Data frame of pixel metadata with x_tf, y_tf and pixel_id columns.
##' @param control.matrix Matrix of control sample intensities (features x control pixels).
##' @param min.neighbours Integer; minimum number of neighbouring pixels required (default 3).
...
##'
##' Uses local differential peaks to run ORA and return pathway results for a given pixel index (row) within the sample.
##'
##' @param row Integer; index (row number) within metadata.per.sample corresponding to the target pixel.
##' @param intensity.per.sample Pixel-by-feature intensity matrix for the sample.
##' @param metadata.per.sample Data frame of pixel metadata for the sample (must contain x_tf, y_tf and pixel_id).
...
##'
##' Iterates over samples and computes per-pixel ORA results in parallel. Returns a named list of per-sample ORA result data frames.
##'
##' @param intensity.matrix Pixel-by-feature intensity matrix (all samples concatenated).
##' @param bulk.intensity.matrix Feature-by-sample matrix used to build control sets.
##' @param metadata Data frame of per-pixel metadata containing Sample and pixel_id columns.
